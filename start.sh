#!/bin/bash
# =============================================================
# Enterprise SQL Assistant V3 — Launch Script
# JDK HttpServer Backend (com.sun.net.httpserver) + Multi-DB JDBC
# =============================================================
...
# Check if compiled
if [ ! -f "$BUILD_DIR/SqlAssistantServer.class" ]; then
...
echo "Starting Enterprise SQL Assistant V3 on port $PORT..."
